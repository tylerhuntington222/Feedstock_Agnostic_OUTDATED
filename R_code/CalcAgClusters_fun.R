...
# PURPOSE:
# An analysis script to find the geographic clusters crop and pasture land 
# within each US county. Weighted centroids will serve as the nodes in a network 
# analysis for
